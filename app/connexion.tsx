...
export default function ConnexionScreen() {
  ...
  const handleLogin = async () => {
    setFormData({...formData,username:usernames,password:passwords})
  ...
  return (
    ...
    <Stack.Screen
        options={{
          headerLeft: () => null, // enlève la flèche retour
        }}
      />
    <View style={styles.wrapper}>
      <View style={styles.container}>
        ...
        <Text style={styles.registerText}>
          ...
          <TouchableOpacity onPress={handleAddCompte}>
